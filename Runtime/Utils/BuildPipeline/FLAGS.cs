...
namespace Utility
{
    ...
    #error  "DEBUG_TRACE in RELEASE build. Remove DEBUG_TRACE flag from Scripting Define Symbols (Player Settings)"
#endif

    public static class FLAGS
    {
        public const string PLATFORM_STANDALONE_LINUX = "PLATFORM_STANDALONE_LINUX";
